# Ubuntu Noble autoinstallation with cloud-init config

Script `create-iso.sh` prepares ISO for [Ubuntu Noble](https://releases.ubuntu.com/noble/) unnatended installation with cloud-init config.  
